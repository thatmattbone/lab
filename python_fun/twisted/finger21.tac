...
class IPerspectiveFinger(Interface):
    ...
    def remote_getFooBars():
        """return some foos and bars"""
...
class PerspectiveFingerFromService(pb.Root):
    ...
    def remote_getFooBars(self):
        return self.service.getFooBars()
...
class FingerService(service.Service):
    ...
    def getFooBars(self):
        return defer.succeed("This is getFoobars()")
